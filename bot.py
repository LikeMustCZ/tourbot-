...
from handlers import (
    start, main_menu,
    trips_menu, new_trip_start, new_trip_company, new_trip_route, new_trip_date,
    new_trip_seats, new_trip_price, new_trip_confirm, new_trip_save,
    trip_detail, trip_edit_menu, trip_edit_field, trip_edit_save,
    ...
    booking_comment, booking_confirm, booking_save,
